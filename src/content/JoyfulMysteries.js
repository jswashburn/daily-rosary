...
export default function JoyfulMysteries() {
  return (
    <div className="content">
      ...
      <ContentSection snap title="The Annunciation of Our Lord">
        ...
        "Hail, favored one! The Lord is with you." But she was greatly troubled
        at what was said and pondered what sort of greeting this might be. Then
        ...
        kingdom there will be no end." Mary said, "Behold, I am the handmaid of
        the Lord. May it be done to me according to your word." Then the angel
        departed from her. (Luke 1:26-33, 38) As an angel proclaimed the
        conception of Christ in Mary's virginal womb, so do mothers and fathers
        learn every day of the conception of their child. Let us pray to the
        Mother of all the Living that every child be treasured and protected
        from the first moment of conception as an inestimable and wondrous gift
        of God.
      </ContentSection>

      <ContentSection snap title="The Visitation">
        ...
        greeting reached my ears, the infant in my womb leaped for joy. Blessed
        are you who believed that what was spoken to you by the Lord would be
        fulfilled." (Luke 1:39-45) As the child in Elizabeth's womb leaped for
        joy when the Blessed Virgin, pregnant with the Son of God, came to meet
        her, so may our hearts leap with joy at the wonders of new life promised
        in every expectant mother.
      </ContentSection>

      <ContentSection snap title="The Nativity of Jesus">
        ...
        great fear. The angel said to them, "Do not be afraid; for behold, I
        ...
        Messiah and Lord. And this will be a sign for you: you will find an
        infant wrapped in swaddling clothes and lying in a manger." (Luke 2:
        6-12) In the birth of every child we see the birth of Christ Jesus in
        the Bethlehem stable. Let us commend all new mothers and fathers and
        every newborn child to the protection and intercession of the Mother of
        God and Mother of all Christians.
      </ContentSection>

      <ContentSection snap title="The Presentation in the Temple">
        ...
        he should not see death before he had seen the Messiah of the Lord. He
        came in the Spirit into the temple; and when the parents brought in the
        child Jesus to perform the custom of the law in regard to him, he took
        ...
        your salvation, which you prepared in sight of all the peoples, a light
        for revelation to the Gentiles, and glory for your people Israel." (Luke
        2:25-32) As Christ was consecrated to God at his presentation in the
        temple, so may we consecrate all children to that holiness, purity, and
        innocence by which they lead us to God. "A little child shall lead
        them."
      </ContentSection>
      ...
      <ContentSection snap title="The Annunciation of Our Lord">
        ...
        to them. (Luke 2:41-50) As the Christ Child was found in the temple by
        the Blessed Virgin Mary and Saint Joseph, so we pray for all children,
        especially those lost and forgotten. May the Gospel of Life impel us to
        find them when they are most in need and to lead them home to a place
        where they are treasured, protected, and loved.
      </ContentSection>
    </div>
  );
}
